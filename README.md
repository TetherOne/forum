Сайт представляет собой форум для публикации статей (аналог Habr), при разработке использовался микрофреймворк 
Flask 3.0.0 и SQLAlchemy 2.0.23 + alembic для работы с базой данных.
